export default {
  ...
  prmMoneroReciveAdressBegin:
    "기본 모네로 수신 주소는 {characters}로 시작합니다.",
  ...
  // COHOSTS
  cohost: "공동 호스트",
  cohostPage: "공동 호스트 페이지",
  cohostDes: "{path} XMR 채팅 관리",
  inviteCohosts: "공동 호스트 초대",
  noCohosts: "아직 공동 호스트가 없습니다",
  cohostsCanHelpYou:
    "공동 호스트는 XMR 채팅을 관리하는 데 도움을 줄 수 있는 사용자입니다.",
  youCanInviteCohosts: "아래 버튼을 사용해 공동 호스트를 초대할 수 있습니다.",
  removeYourselfFromCohost:
    "정말 스스로 공동 호스트에서 제거하시겠습니까? 다시 공동 호스트가 되려면 재초대가 필요합니다.",
  youRemovedFromCohost: "공동 호스트에서 제거되었습니다.",
  removeFromCohost: "공동 호스트에서 제거",
  removeCohost: "공동 호스트 제거",
  removeThisCohost: "이 공동 호스트를 제거하시겠습니까?",
  cohostRemoved: "공동 호스트가 제거되었습니다",
  ...
  color: "색상",
  sound: "소리",
  wantToDeleteTier: "정말 이 티어를 삭제하시겠습니까?",
  deleteTier: "티어 삭제",
  tierDeleted: "티어가 삭제되었습니다",
  createTier: "티어 생성",
  createNewTier: "새 티어 만들기",
  edit: "편집",
  delete: "삭제",
  pageTierUpdated: "티어가 업데이트되었습니다.",
  pageTierCreated: "티어가 생성되었습니다.",
  minAmountXMR: "최소 금액 (XMR)",
  description: "설명",
  soundOBS: "소리 (OBS)",
  uploaded: "업로드됨:",
  clear: "지우기",
